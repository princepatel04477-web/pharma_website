...
const data: ProductCategory[] = [
  ...
  },
  {
    ...
    dosageForms: ["Tablets", "Oral liquids", "Creams", "Gels"],
    description:
      "Enquire about non-prescription product categories for everyday healthcare, including analgesics, antacids, oral care and topical preparations. OTC status is destination-dependent, not a universal exemption from import rules. Confirm product classification, CoA, safety information and applicable manufacturing and sale certificates for each enquiry.",
    skuCount: null,
    representativeMolecules: [],
    packagingOptions: [
      "Blister packs — subject to product review",
  ...
  },
  {
    ...
    dosageForms: ["Tablets", "Capsules", "Powders", "Oral liquids"],
    description:
      "Explore vitamins, minerals, protein supplements and selected herbal preparations as a proposed sourcing category. Food-supplement and herbal classifications require product-specific review, including applicable FSSAI scope in India. Request composition, CoA, labelling information and applicable safety documentation; no efficacy claims are made here.",
    skuCount: null,
    representativeMolecules: [],
    packagingOptions: [
      "Blister packs — subject to product review",
