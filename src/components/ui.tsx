...
export function ClosingCTA({ dark = false }: { dark?: boolean }) {
  return (
    <section className={`closing-cta ${dark ? "dark" : ""}`}>
      <div className="container">
        <span className="meta">{copy.closingLabel}</span>
        <h2 className="display">{copy.closingTitle}</h2>
        ...
        <p className="meta">{navigation.labels.disclaimer}</p>
      </div>
    </section>
  );
}
